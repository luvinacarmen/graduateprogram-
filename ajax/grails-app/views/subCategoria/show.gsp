...
<html>
    ...
    <body>
        ...
        <div id="show-subCategoria" class="content scaffold-show" role="main">
            ...
            <f:display bean="subCategoria" />
            <g:form resource="${this.subCategoria}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.subCategoria}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
